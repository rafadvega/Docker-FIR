...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/nginx/conf.d/ssl/fir-server.key -out /etc/nginx/conf.d/ssl/fir-server.crt -subj "/C=ES/ST=Pontevedra/L=Vigo/O=rdevega/OU=rdevega/CN=fir.rdevega.es"
